...
const DownloadButton = () => {
  ...
  const handleDownload = () => {
    const downloadUrl = 'https://drive.google.com/file/d/14rJNC3gxvqdmzZptDAfYBB0GPvcoD62_/view?usp=sharing';
  ...
  return (
    <div>
      <button className='w-auto h-auto' onClick={handleDownload}>
